...
/*   Updated: 2025/07/07 15:48:30 by macauchy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/cub3d.h"

// static int	rotate_player_by_mouse_int(t_game *game, int delta_x)
// {
// 	double	rot_speed;
// 	double	old_dirx;
// 	double	old_planex;
...
// 	previous_y = y;
// 	rotated = rotate_player_by_mouse_int(game, delta_x);
